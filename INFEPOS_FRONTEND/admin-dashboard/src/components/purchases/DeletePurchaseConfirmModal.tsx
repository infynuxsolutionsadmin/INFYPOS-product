...
interface DeletePurchaseConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
const DeletePurchaseConfirmModal: React.FC<DeletePurchaseConfirmModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
  purchase,
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Cancel Purchase Order</h3>
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Are you sure you want to cancel purchase order <span className="font-semibold text-gray-800">{purchase.purchaseNumber}</span>? 
                    This will mark the status as CANCELLED. Only DRAFT purchases can be cancelled here.
                  </p>
                  {error && (
...
export default DeletePurchaseConfirmModal;
